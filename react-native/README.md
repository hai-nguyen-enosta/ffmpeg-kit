...
[Packages](https://github.com/hai-nguyen-enosta/ffmpeg-kit/wiki/Packages) wiki page to see the names of those
...
[LTS Releases](https://github.com/hai-nguyen-enosta/ffmpeg-kit/wiki/LTS-Releases) wiki page to see how they differ from each
other.
...
the [FFmpegKit Test](https://github.com/hai-nguyen-enosta/ffmpeg-kit-test) project.

### 5. Tips

See [Tips](https://github.com/hai-nguyen-enosta/ffmpeg-kit/wiki/Tips) wiki page.

### 6. License

See [License](https://github.com/hai-nguyen-enosta/ffmpeg-kit/wiki/License) wiki page.

### 7. Patents

See [Patents](https://github.com/hai-nguyen-enosta/ffmpeg-kit/wiki/Patents) wiki page.
